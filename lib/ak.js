...
function formatfilename( _text )
{
	var text = _text;
	text = text.replaceAll( "ç" , "c" );
	text = text.replaceAll( "ü" , "u" );
	text = text.replaceAll( /[éèë]/ig , "e" );
...
{
   var menu=[ "/usr","akaikoshi","news","demos","pixels","ascii","photos", "stickers", "downloads", "bonuses","links","about" ];
   var ii, prefix,hlink;
   prefix="&nbsp;&nbsp;";
   hlink="index";
...
{
   // empty_line();
    document.write( "<hr><table width=100% border=0 cellpadding=0 cellspacing=0>");
    document.write( "<tr><td align=center><h1>" ); 
 
    document.write( "<font size=1>(c) akaikoshi - since 2025<P align=right><PRE>\
akaikoshi@proton.me - <a href='https://demozoo.org/groups/148458/'>demozoo</A> - <a href='https://www.pouet.net/groups.php?which=16711'>pouet</A> - <a href='https://www.youtube.com/@akaik%C5%8Dshi'>youtube</A> - <a href='https://bsky.app/profile/akaikoshi.bsky.social'>bsky</A> - <a href='https://mastodon.social/@akaikoshi'>mastodon</A><P align=right><PRE>\
     _       _ _           _   _ \
